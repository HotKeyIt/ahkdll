PostMessage(msg,ByRef wparam:=0,ByRef lparam:=0,control:="",aTitle:="",aText:="",aExTitle:="",aExText:=""){
	...
	if !DllCall("PostMessage","PTR",control_window,"UInt",msg,"PTR",IsByRef(wParam)&&wParam+0!=""?wparam:&wParam,"PTR",IsByRef(lParam)&&lParam+0!=""?lparam:&lParam))
		return
	ErrorLevel:=0
  If IsByRef(wParam)
